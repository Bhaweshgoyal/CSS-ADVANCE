...
//     for(    let i = 0  ; i < data.productsSelected; i ++){
//         OrderDetailsHTML+='<div class = "order-details-product d-flex flex-row">'
//         +'<img src = "https://picsum.photos/200/300"</div>'
//         + '<div class =""product-name text-center>' + data.productsSelected[i].name +'</div>'
//         +'<div class = "product-price text-center"?&#8377; ' + data.productsSelected[i].cost +'</div>'
//     }
